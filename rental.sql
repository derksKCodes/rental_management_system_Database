...
CREATE TABLE Payments (
    ...
    PaymentMethod ENUM('Cash', 'Credit Card', 'Bank Transfer', 'Check', 'Other') NOT NULL,
...
CREATE TABLE MaintenanceRequests (
    ...
    FOREIGN KEY (PropertyID) REFERENCES Properties(PropertyID),
    FOREIGN KEY (TenantID) REFERENCES Tenants(TenantID),
    CONSTRAINT CHK_RequestDates CHECK (RequestDate <= COALESCE(ScheduledDate, CompletedDate, RequestDate))
);
